...
export const AddSol = ({
  ...
  return (
    <div className="items-center justify-center gap-x-3 space-y-3 sm:flex sm:space-y-0">
      <span className="relative inline-block w-full overflow-hidden rounded-sm p-[1.5px]">
        ...
        <div className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-sm bg-white text-xs font-medium backdrop-blur-3xl dark:bg-gray-950">
          <Button
            ...
            disabled={pending}
            className={cn(
              "group inline-flex h-[unset] w-full items-center justify-center rounded-sm border-[1px] border-input bg-gradient-to-tr from-zinc-300/20 via-purple-400/30 to-transparent px-4 py-2 text-center text-gray-900 transition-all hover:bg-gradient-to-tr hover:from-zinc-300/30 hover:via-purple-400/40 hover:to-transparent dark:from-zinc-300/5 dark:via-purple-400/20 dark:text-white dark:hover:from-zinc-300/10 dark:hover:via-purple-400/30",
              pending && "opacity-50"
            )}
          >
            Get Test SOL ◎
